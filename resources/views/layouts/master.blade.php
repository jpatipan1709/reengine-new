        ...
        <header class="header-area header_absolute header_height-90 header-sticky">
            <div class="container-fluid container-fluid--cp-100">
                <div class="row align-items-center">
                                ...
                                <ul class="justify-content-center">
                                    <li class="has-children">
                                        <a href="#section1" class="scroll-link"
                                            data-element-id="section1"><span>หน้าแรก</span></a>
                                    </li>
                                    <li class="has-children">
                                        <a href="#section2" class="scroll-link"
                                            data-element-id="section2"><span>เกี่ยวกับเรา</span></a>
                                    </li>
                                    <li class="has-children">
                                        <a href="#section3" class="scroll-link"
                                            data-element-id="section3"><span>สินค้าของเรา</span></a>
                                    </li>
                                    <li class="has-children">
                                        <a href="#section4" class="scroll-link"
                                            data-element-id="section4"><span>ติดต่อ</span></a>
                                    </li>
                                    <li class="has-children has-children--multilevel-submenu">
                                        <a href="#"><span>เข้าสู่ระบบ</span></a>
                                        <ul class="submenu">
                                            <li><a href="" data-toggle="modal"
                                                    data-target="#exampleModal"><span>Reenigne Thailand</span></a></li>
                    ...
                    <div class="col-sm-3 col-sm-3 col-6">
